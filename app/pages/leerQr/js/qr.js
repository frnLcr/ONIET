...
btnStartScan.addEventListener('click', function() {
    btnStartScan.style.display = "none"; // Ocultar el botón de detener escane
    ...
    navigator.mediaDevices.getUserMedia({ video: { facingMode: "environment" } })
        .then(function(userMediaStream) {
            ...
            video.muted = true; // Silenciar el video para evitar problemas de autoplay
...
btnStopScan.addEventListener('click', function() {
    ...
    btnStartScan.style.display = "inline"; // Mostrar botón para iniciar el escaneo
});